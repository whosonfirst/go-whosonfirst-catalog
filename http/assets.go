...
func staticJavascriptMapzenWhosonfirstInspectorJs() (*asset, error) {
	...
	info := bindataFileInfo{name: "static/javascript/mapzen.whosonfirst.inspector.js", size: 8157, mode: os.FileMode(420), modTime: time.Unix(1563548737, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func staticCssMapzenWhosonfirstInspectorCss() (*asset, error) {
	...
	info := bindataFileInfo{name: "static/css/mapzen.whosonfirst.inspector.css", size: 1306, mode: os.FileMode(420), modTime: time.Unix(1563546049, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
